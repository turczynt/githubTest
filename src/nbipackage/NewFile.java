...
public class NewFile
{
	...
	public boolean dopiszUtf(String dane)
	{
		boolean flaga=true;
		try
		{
			FileOutputStream stream=new FileOutputStream(this.sciezka,true);
			java.io.OutputStreamWriter zap=new java.io.OutputStreamWriter(stream,"UTF8");
			zap.write(dane);
...
//			zap.write(dane.getBytes());
	...
	{////////////////////////W pliku jeden String
        ...
        public String getAllFromFile(String filePath)
        {
            String out="";
	...
	{
	    String content = null;
	   File file = new File(this.sciezka); //for ex foo.txt
	   try {
	...
	public String[] getLinia(String szukany,String tekst)
	...
	static public String getFirstLine(String[] szukany,String tekst)
	{
	...
	public boolean setReadOnlyForOwner()
	{
	    File a =new File(sciezka);
	...
	public String getTokens(String tekst,String t1,String t2)
	{
	...
	public String getTokens(String tekst,String t1,String t2,String dzielnik)
	{
