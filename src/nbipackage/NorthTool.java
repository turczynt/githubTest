...
public class NorthTool
{
    ...
    public java.util.ArrayList<String> getCellIdsList(String RncName, String NodebName) throws NBIAnsException//LST cellsId for specyfic node
    {
    ...
    public java.util.ArrayList<String> getGCellNamesList(String BscName, String BtsName) throws NBIAnsException//LST cellsId for specyfic node
    {
        //north.make("REG NE:NAME="+RncName);
        //String lstUcell=north.make("LST UCELL:NODEBNAME=\""+NodebName+"\",LSTFORMAT=VERTICAL");
        //NPack NPCAK=new NPack(lstUcell.split("\n"),new String[]{"LST UCELL:"},new String[]{"List Cell Basic Information"},new String[]{"---    END"});
    ...
    public java.util.ArrayList<Paczka> lstUlgroup(String NodebName) throws NBIAnsException//LST ULGROUP
    {
    ...
    public java.util.ArrayList<Paczka> lstDlgroup(String NodebName)throws NBIAnsException										//LST ULGROUP
	{
    ...
    public java.util.ArrayList<Paczka> lstDualCellGrp(String NodeName)			throws NBIAnsException						//LST DUALCELLGRP
	{
    ...
    public java.util.ArrayList<Paczka> dspEthPortOnNode(String NodebName) throws NBIAnsException//DSP ETHPORT
    {
        //north.make("REG NE:NAME="+NodebName);
    ...
    public java.util.ArrayList<Paczka> dspBRD(String NodebName) throws NBIAnsException//DSP BRD
    {
        //north.make("REG NE:NAME="+NodebName);
    ...
    public java.util.ArrayList<Paczka> lstUsccpch(String RncName,String cellid)	throws NBIAnsException		//LST USCCPCH:
	{
    ...
    public java.util.ArrayList<Paczka> lstUcell(String RncName, String NodebName) throws NBIAnsException//LST UCELL:
    {
        //north.make("REG NE:NAME="+RncName);
        if (NodebName != null)
        {
     ...
     public java.util.ArrayList<Paczka> lstGcell(String BscName, String BtsName) throws NBIAnsException//LST UCELL:
    {
        //north.make("REG NE:NAME="+RncName);
        if (BtsName != null)
        {
    ...
    public java.util.ArrayList<Paczka> lstUnodeb(String RncName) throws NBIAnsException//LST UNODEB:
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public java.util.ArrayList<Paczka> lstBTSIPPM(String BSCName,String ani) throws NBIAnsException//LST BTSIPPM: IDTYPE=BYID, BTSID=405
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public java.util.ArrayList<Paczka> lstIPPM(String RncName,String ani) throws NBIAnsException//LST IPPM
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public Paczka lstSpecUcellByName(String RncName, String cellname) throws NBIAnsException//LST UCELL: LSTTYPE=BYNAME
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public Paczka lstSpecUcellByCellid(String RncName, String cellid) throws NBIAnsException//LST UCELL: LSTTYPE=CELLID
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    //LST UCELLURA:CELLID
    public java.util.ArrayList<Paczka> lstUcellUra(String RncName, String cellid) throws NBIAnsException//LST UCELL: LSTTYPE=CELLID
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public Paczka lstSpecGcellByName(String RncName, String cellname) throws NBIAnsException//LST GCELL: LSTTYPE=CELLID
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public java.util.ArrayList<Paczka> lstGcellGPRS(String RncName, String cellname) throws NBIAnsException//LST GCELLGPRS: IDTYP=BYNAME
    {
        //north.make("REG NE:NAME="+RncName);
     ...
     * @return
     */
    public java.util.ArrayList<String> findNodeName(String RncName, String regex) throws NBIAnsException//DSP UCELL:
    {
    ...
    public java.util.ArrayList<String> findBtsName(String BscName, String regex) throws NBIAnsException//DSP UCELL:
    {
        //String regName=north.make("REG NE:NAME="+RncName);//DSP UCELL: DSPT=BYCELL, LstFormat=VERTICAL
	       java.util.ArrayList<String> odpowiedz=new java.util.ArrayList<String>();

        String lstUcell = north.make(BscName, "LST BTS:");
	odpowiedz=findBtsNameFromNorthOdp(lstUcell,regex);
      
        return odpowiedz;
    }
    public java.util.ArrayList<String> findBtsNameFromNorthOdp(String lstUcell, String regex)
    {
	NPack NPCAK = new NPack(lstUcell);//.split("\n"), new String[]{"DSP UCELL:"}, new String[]{"Cell state information"}, new String[]{"---    END"});
	java.util.ArrayList<String> odpowiedz=new java.util.ArrayList<String>();
        java.util.ArrayList<Paczka> listaTymczasowa = NPCAK.getAllPacks();
    ...
    public Paczka LstUcellAccessstrict(String RncName, String CELLID) throws NBIAnsException//LST UCELLACCESSSTRICT:
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public Paczka LstUnodebip(String RncName, String NodeName) throws NBIAnsException//LST UNODEBIP: LSTTYPE=BYNAME
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public Paczka LstIPOAPVC(String RncName, String peerIp) throws NBIAnsException//LST UNODEBIP: LSTTYPE=BYNAME
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public java.util.ArrayList<Paczka> lstGext2Gcell(String bscName, String EXT2GCELLNAME)throws NBIAnsException
    {
    ...
    public java.util.ArrayList<Paczka> lstGext3Gcell(String RncName, String EXT3GCELLNAME)throws NBIAnsException
    {
    ...
    public java.util.ArrayList<Paczka> lstUext2Gcell(String rncName, String EXT2GCELLNAME)throws NBIAnsException
    {
        //String regOdp=north.make("REG NE:NAME="+rncName);
        ...
        if(lst.contains("Number of results = 1)"))
            NPCAK = new NPack(lst,NPack.FORMAT_PIONOWY);
        else
            NPCAK = new NPack(lst,NPack.FORMAT_POZIOMY);
        java.util.ArrayList<Paczka> listaTymczasowa = NPCAK.getAllPacks();
        //System.out.println(lst);
        if (listaTymczasowa != null && listaTymczasowa.size() > 0)
        {
    ...
    public java.util.ArrayList<Paczka> lstUext3Gcell(String BscName, String EXT2GCELLNAME,String externalRncId)throws NBIAnsException
    {
        //String regOdp=north.make("REG NE:NAME="+rncName);
        String lst = north.make(BscName, "LST UEXT3GCELL: LSTTYPE=BYCELLID, CELLID=" + EXT2GCELLNAME + ",NRNCID="+externalRncId+",LSTFORMAT=HORIZONTAL");
        //LST UEXT2GCELL:LSTTYPE=ByGSMCellName,GSMCELLNAME="4459813G_BYD2102A_O_LOCHOWO";
    ...
    public java.util.ArrayList<Paczka> lstUext3Gcell(String BscName, String EXT2GCELLNAME)throws NBIAnsException
    {
        //String regOdp=north.make("REG NE:NAME="+rncName);
    ...
    public java.util.ArrayList<Paczka> LstAdjnode(String RncName) throws NBIAnsException//LST ADJNODE: LSTTYPE=BYID
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public java.util.ArrayList<Paczka> LstAdjnodeHorizontal(String RncName) throws NBIAnsException//LST ADJNODE: LSTTYPE=BYID
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public java.util.ArrayList<Paczka> LstSctplnk(String NodeName) throws NBIAnsException//LST SCTPLNK:
    {
    ...
    public Paczka LstSctplnkOnRNC(String rncName, String sctpNr)throws NBIAnsException
    {
        //north.make("REG NE:NAME=\""+rncName+"\"");
    ...
    public java.util.ArrayList<Paczka> LstAdjnode2(String RncName) throws NBIAnsException//LST ADJNODE: LSTTYPE=BYID
    {
        ////north.make("REG NE:NAME="+RncName);
    ...
    public java.util.ArrayList<Paczka> LstAdjnodeByName(String RncName, String NodebName)throws NBIAnsException //LST ADJNODE: LSTTYPE=BYNAME
    {
    ...
    /*#################################################################################*/
    public java.util.ArrayList<Paczka> LstImalink(String NodeName) throws NBIAnsException//LST IMALNK:
    {
        if (NodeName != null)
        {
    ...
    public Paczka lstSaalnkn(String RncName, String srn, String sn, String saalId) throws NBIAnsException//LST SAALNKN:
    {
        //north.make("REG NE:NAME=\""+ RncName+"\"");
    ...
    public Paczka lstImalnk(String RncName, String srn, String sn, String imalIndex) throws NBIAnsException//LST IMALNK:
    {
        //north.make("REG NE:NAME=\""+ RncName+"\"");
    ...
    public java.util.ArrayList<Paczka> lstSaalnknOnNode(String NodeName) throws NBIAnsException//LST SAALNKN: ON NODE SIDE
    {
        //String regOdp=north.make("REG NE:NAME=\""+ NodeName+"\"");
    ...
    public Paczka LstAll2Path(String RncName, String ani, String pathid) throws NBIAnsException//LST AAL2PATH:
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public Paczka LstImagrp(String RncName, String imagrp) throws NBIAnsException//LST IMAGRP:BYIMAGRPN
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public Paczka LstCmctrl(String nodeName) throws NBIAnsException//LST CMCTRL:
    {
        nodeName = nodeName.replaceAll("\"", "");
        //north.make("REG NE:NAME=\""+nodeName+"\"");
    ...
    public java.util.ArrayList<Paczka> LstAll2Path(String RncName, String ani) throws NBIAnsException//LST AAL2PATH:
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public String CellBarrIsAccess(String BtsName,String CellName)throws NBIAnsException
    {
    ...
    public Paczka LST_GCELLIDLEBASIC(String BscName,String CellName)throws NBIAnsException									//LST GCELL:
    {
    ...
    public java.util.ArrayList<Paczka> LstIpPath(String RncName, String ani) throws NBIAnsException//LST IPPATH:
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public java.util.ArrayList<Paczka> lstAll2PathOnNode(String NodeName) throws NBIAnsException//LST AAL2PATH: ON NODE SIDE
    {
    ...
    public java.util.ArrayList<Paczka> lstIppathOnNode(String NodeName) throws NBIAnsException//LST IPPATH: ON NODE SIDE
    {
        NodeName = NodeName.replaceAll("\"", "");
        //String odpReg=north.make("REG NE:NAME=\""+NodeName+"\"");
    ...
    public java.util.ArrayList<Paczka> lstIppmOnNode(String NodeName) throws NBIAnsException//LST IPPM: ON NODE SIDE
    {
        NodeName = NodeName.replaceAll("\"", "");
        //String odpReg=north.make("REG NE:NAME=\""+NodeName+"\"");
    ...
    public java.util.ArrayList<Paczka> dspIppmsessionOnNode(String NodeName) throws NBIAnsException//DSP IPPMSESSION: ON NODE SIDE
    {
        NodeName = NodeName.replaceAll("\"", "");
    ...
    public String getNodebNameById(String RncName, String NodeId)throws NBIAnsException
    {
    ...
    public int maxNrOfLocellOldVer(String NodeName)throws NBIAnsException															//
	{
		//String regOdp=north.make("REG NE:NAME="+NodeName,"---    END","n");

		String lstUcell=north.make(NodeName,"DSP LICENSE:FUNCTIONTYPE=NODEB");
    	...
    	public int maxNrOfLocell(String NodeName)throws NBIAnsException															//
	{
		String lstUcell=north.make(NodeName,"DSP LICENSE:FUNCTIONTYPE=NODEB");
    ...
    public String softwareVersion(String NodeName)throws NBIAnsException //LST SOFTWARE:
    {
        String softVer = "";
        //String regOdp=north.make("REG NE:NAME=\""+NodeName+"\"");
    ...
    public boolean isRAN13(String NodeName)throws NBIAnsException
    {
    ...
    public boolean isRAN12(String NodeName)throws NBIAnsException
    {
        String sftVer = softwareVersion(NodeName);
    ...
    public boolean isRAN15(String NodeName)throws NBIAnsException
    {
        String sftVer = softwareVersion(NodeName);
    ...
    public Paczka LstAdjmap(String RncName, String ani)throws NBIAnsException
    {
        //north.make("REG NE:NAME="+RncName);
    ...
    public java.util.ArrayList<Paczka> lstIubcpOnNode(String NodeName) throws NBIAnsException//LST IUBCP: ON NODE SIDE
    {
        //north.make("REG NE:NAME=\""+NodeName+"\"");
    ...
    public java.util.ArrayList<Paczka> lstIubcpOnRNC(String rncName, String NodeName) throws NBIAnsException//LST IUBCP: ON NODE SIDE
    {
        //north.make("REG NE:NAME=\""+rncName+"\"");
    ...
    public Paczka lstAal2NodeOnNode(String NodeName) throws NBIAnsException//LST AAL2NODE: ON NODE SIDE
    {
        //north.make("REG NE:NAME=\""+NodeName+"\"");
    ...
    public String CellIsUnbloced(String RncName, String cellId) throws NBIAnsException//cell is Blocked/Unblocekd
    {
    ...
    public String CellIsUnblocedByLST(String RncName, String cellId) throws NBIAnsException//cell is Blocked/Unblocekd
    {
       Paczka paczka= lstSpecUcellByCellid(RncName,  cellId);
       if(paczka!=null)
       {
	   String blkVal=paczka.getWartosc("Cell administrative state");
	   return blkVal;
       }
       return "";
    }

    public String CellStateExplanation(String RncName, String cellId) throws NBIAnsException//state explanation
    {
        //DSP UCELL: DSPT=BYCELL,CELLID=65337,LSTFORMAT=VERTICAL
        //north.make("REG NE:NAME="+RncName);
        String dspCell = north.make(RncName, "DSP UCELL: DSPT=BYCELL,CELLID=" + cellId + ",LSTFORMAT=VERTICAL");
    ...
    public String CellStateBTSExplanation(String BscName, String cellName) throws NBIAnsException//state explanation #for bts
    {
        //DSP UCELL: DSPT=BYCELL,CELLID=65337,LSTFORMAT=VERTICAL
    ...
    public String IsBlocked2Gcell(String BscName, String cellName) throws NBIAnsException//state explanation #for bts
    {
        //DSP UCELL: DSPT=BYCELL,CELLID=65337,LSTFORMAT=VERTICAL
        //north.make("REG NE:NAME=\""+BtsName+"\"");
        //DSP GCELLSTAT: IDTYPE=BYNAME, CELLNAMELST="1167211G_RYC3310A_O_SKLADOWA";
    ...
    public String getNodeBType(String nodebName) throws NBIAnsException//Nodeb type LST NODEBTYPE:
    {
        if (nodebName != null)
        {
    ...
    public Paczka LST_GCELL(String BtsName, String CellName) throws NBIAnsException//LST GCELL:
    {
    ...
    public java.util.ArrayList<Paczka> LST_GCELL_ALL(String BtsName) throws NBIAnsException//LST GCELL:
    {
    ...
    public java.util.ArrayList<Paczka> LST_GTRX(String BscName, String CellName) throws NBIAnsException//LST GTRX: for specyfic Cell
    {
    ...
    public java.util.ArrayList<Paczka> LST_GTRX(String BscName) throws NBIAnsException//LST GTRX: for whole bsc
    {


        String lstUcell = north.make(BscName, "LST GTRX: IDTYPE=BYNAME,LSTFORMAT=VERTICAL");
    ...
    public java.util.ArrayList<String> getUnUsedTRXIDonBSC(String BscName)throws NBIAnsException//8191
    {
	int maxValue=8191;
	java.util.ArrayList<String> used=getUsedTRXIDonBSC(BscName);
	java.util.ArrayList<String> UNused=new java.util.ArrayList<String>();
	...
	return UNused;
	//LST_GTRX(String BscName)
    }
    public java.util.ArrayList<Paczka> LST_PTPBVC_ALL(String BscName)throws NBIAnsException
    {
	String odp=north.make(BscName, "LST PTPBVC:");
	NPack pack=new NPack(odp);
	return pack.getAllPacks();
    }

    public java.util.ArrayList<Paczka> LST_PTPBVC_BYCELLNAME(String BscName,String CellName)throws NBIAnsException
    {
	java.util.ArrayList<Paczka> ALL=LST_PTPBVC_ALL(BscName);
	java.util.ArrayList<Paczka> out=new java.util.ArrayList<Paczka>();
	for(int i=0;i<ALL.size();i++)
	{
	    Paczka p=ALL.get(i);
	    String cellNameFromPack=p.getWartosc("Cell Name");
	    if(cellNameFromPack.equals(CellName))
		out.add(p);
	}
	return out;
    }
    public java.util.ArrayList<Paczka> LST_PTPBVC_BYCELLID(String BscName,String CellId)throws NBIAnsException
    {
	java.util.ArrayList<Paczka> ALL=LST_PTPBVC_ALL(BscName);
	java.util.ArrayList<Paczka> out=new java.util.ArrayList<Paczka>();
	for(int i=0;i<ALL.size();i++)
	{
	    Paczka p=ALL.get(i);
	    String cellIdFromPack=p.getWartosc("Cell Index");
	    if(cellIdFromPack.equals(CellId))
		out.add(p);
	}
	return out;
    }
    public static java.util.ArrayList<Paczka> LST_PTPBVC_BYCELLNAME(String BscName,String CellName,java.util.ArrayList<Paczka> ALL)throws NBIAnsException
    {
	//java.util.ArrayList<Paczka> ALL=LST_PTPBVC_ALL(BscName);
	java.util.ArrayList<Paczka> out=new java.util.ArrayList<Paczka>();
	for(int i=0;i<ALL.size();i++)
    ...
    public static java.util.ArrayList<Paczka> LST_PTPBVC_BYCELLID(String BscName,String CellId,java.util.ArrayList<Paczka> ALL)throws NBIAnsException
    {
    ...
    public java.util.ArrayList<String> getUsedTRXIDonBSC(String BscName)throws NBIAnsException
    {
	java.util.ArrayList<String> used=new java.util.ArrayList<String>();
	java.util.ArrayList<Paczka> listaTRX=LST_GTRX(BscName);
	for(int i=0;i<listaTRX.size();i++)
	{
	    String trxId=listaTRX.get(i).getWartosc("TRX ID");
	    if(!used.contains(trxId))
		used.add(trxId);
	}
	return used;
    }
    public java.util.ArrayList<Paczka> LST_TRXBIND2PHYBRD(String BscName, String CellName) throws NBIAnsException//LST TRXBIND2PHYBRD:IDTYPE=BYNAME,
    {
    ...
    public Paczka LST_TRXBIND2PHYBRDbyTRX(String BscName, String TRXID) throws NBIAnsException//LST TRXBIND2PHYBRD:IDTYPE=BYID,
    {
    ...
    public java.util.ArrayList<Paczka> LST_GTRXDEV(String BscName, String CellName) throws NBIAnsException//LST GTRXDEV: IDTYPE=BYNAME,
    {
    ...
    public Paczka LST_GCELLFREQ(String BscName, String CellName) throws NBIAnsException//LST GCELLFREQ: IDTYPE=BYNAME,
    {
    ...
    public Paczka LST_GCELLMAGRP(String BscName, String CellName) throws NBIAnsException//LST GCELLMAGRP: IDTYPE=BYNAME,
    {
    ...
    public Paczka LST_ITELSHUTDOWN(String NodebName) throws NBIAnsException//LST ITELSHUTDOWN,
    {
    ...
    public Paczka LST_LOWPOWERPARA(String NodebName) throws NBIAnsException//LST LOWPOWERPARA
    {
    ...
    public java.util.ArrayList<Paczka> LST_GTRXHOP(String BscName, String CellName) throws NBIAnsException//LST GTRXHOP: IDTYPE=BYNAME,
    {
    ...
    public java.util.ArrayList<Paczka> LST_GTRXCHANHOP(String BscName, String CellName) throws NBIAnsException//LST GTRXCHANHOP: IDTYPE=BYNAME,
    {
    ...
    public java.util.ArrayList<Paczka> LST_GTRXCHAN(String BtsName, String CellName) throws NBIAnsException//LST GTRXCHAN: IDTYPE=BYNAME,
    {
    ...
    public Paczka dspRRUTC(String NodebName, String cn, String srn, String sn) throws NBIAnsException//DSP RRUTC
    {
    ...
    public Paczka dspMTRUTC(String NodebName, String cn, String srn, String sn) throws NBIAnsException//DSP RRUTC
    {
    ...
    public Paczka dspRRU(String NodebName, String cn, String srn, String sn) throws NBIAnsException//DSP RRU:
    {
        ...
        } else
        {
            ...
            public java.util.ArrayList<Paczka> LstAdjmap(String RncName)throws NBIAnsException													//
	{
        ...
        public Paczka LstDifpri(String NodeName)throws NBIAnsException													//
	{
    ...
    public java.util.ArrayList<Paczka> dspRRUTC(String NodebName) throws NBIAnsException//DSP RRUTC
    {
    ...
    public java.util.ArrayList<Paczka> dspMTRUTC(String NodebName) throws NBIAnsException//DSP RRUTC
    {
    ...
    public java.util.ArrayList<Paczka> dspRRU(String NodebName) throws NBIAnsException//DSP RRU:
    {
    ...
    public Paczka LST_GCELLHOPTP(String BtsName, String CellName) throws NBIAnsException//LST GCELLHOPTP: IDTYPE=BYNAME,
    {
    ...
    public Paczka LST_NODEBNAME(String NodebName)throws NBIAnsException //1)	LST NODEBNAME
    {
    ...
    public Paczka LST_SITE(String NodebName)throws NBIAnsException //1)	LST SITE
    {
        //north.make("REG NE:NAME=\""+NodebName.replaceAll("\"","")+"\"");
    ...
    public boolean sendCommend(String komenda, String regName)throws NBIAnsException
    {
        if (komenda != null)
        {
    ...
    public String sendCommendWithAnswear(String regName,String komenda)throws NBIAnsException
    {
        return north.make(regName, komenda);
    }

    public boolean sendCommend(String komenda_regName)throws NBIAnsException
    {
    ...
    public boolean sendCommend(java.util.ArrayList<String> komendy)throws NBIAnsException
    {
    ...
    public Paczka LstImagrp(String RncName,String srn,String sn,String imagrp)		throws NBIAnsException	//LST IMAGRP:BYIMAGRPN,SN,SRN
    {
    ...
    public java.util.ArrayList<Paczka> lstSaalnkn(String RncName,String srn,String sn)throws NBIAnsException	//LST SAALNKN:
    {
    ...
    public Paczka LstImaGrpOnNode(String NodeName)throws NBIAnsException
    {
		NodeName=NodeName.replaceAll("\"","");
    ...
    public String GCellIsUnblocked(String BtsName,String cellName)throws NBIAnsException
    {
		//DSP UCELL: DSPT=BYCELL,CELLID=65337,LSTFORMAT=VERTICAL
    ...
    public Paczka LstNodebstatus(String NodebName) throws NBIAnsException//DSP RRU:
    {
    ...
    public java.util.ArrayList<Paczka> lstALLGext3Gcell(String RncBscName)throws NBIAnsException//,String EXT3GCELLNAME)
    {
    ...
    public java.util.ArrayList<Paczka> lstALLUext3Gcell(String rncName)throws NBIAnsException//,String EXT2GCELLNAME)
    {
    ...
    public Paczka dspEthPort(String NodeName,String srn,String pn)throws NBIAnsException									//LST GCELL: LSTTYPE=CELLID
    {
    ...
    public java.util.ArrayList<Paczka> LstVlanClass(String NodebName)throws NBIAnsException									//DSP UCELL:
    {
    ...
    public Paczka lstVlanMap(String NodeName)throws NBIAnsException	//LST GCELL: LSTTYPE=CELLID
    {
    ...
    public Paczka LST_BTS(String BscName,String BtsName)throws NBIAnsException	//LST BTS: LSTTYPE=BYBTSNAME
    {
    ...
    public Paczka LST_BTSIP(String BscName,String btsIp)throws NBIAnsException	//LST BTSIP: LSTTYPE=BYBTSNAME
    {
    ...
    public java.util.ArrayList<Paczka> lstBtsVlan(String BscName,String BtsId)throws NBIAnsException	//LST IUBCP: ON NODE SIDE
    {
    ...
    public java.util.ArrayList<Paczka> dspAllUcell(String RncName)throws NBIAnsException
    {
	...
	return listaTymczasowa;
     ...
     public java.util.ArrayList<Paczka> lstLocellOnNode(String NodeName) throws NBIAnsException//LST AAL2PATH: ON NODE SIDE
    {

	String typ=getNodeBType(NodeName);
	String lst="";
	if(typ.contains("3900"))
	    lst = north.make(NodeName, "LST ULOCELL:MODE=ALLLOCALCELL");
	else
	    lst = north.make(NodeName, "LST LOCELL:MODE=ALLLOCALCELL");
    ...
    public java.util.ArrayList<Paczka> lstLocell(String RncName, String NodeName) throws NBIAnsException//LST AAL2PATH: ON RNC SIDE
    {
        //String odpReg=north.make("REG NE:NAME=\""+RncName+"\"");
    ...
    public Paczka lstSpecificLocell(String NodeName, String locellId)throws NBIAnsException
    {
        //String regOdp=north.make("REG NE:NAME="+NodeName);
        ...
        {
	    lstUcell = north.make(NodeName, "LST ULOCELL:MODE=LOCALCELL,ULOCELLID=" + locellId);

	    NPCAK = new NPack(lstUcell.split("\n"), new String[]
                {
                    "LST ULOCELL:"
                }, new String[]
                {
